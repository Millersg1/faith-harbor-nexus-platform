...
import { Play, Download, BookOpen, Calendar, Plus, Search, Filter, FileAudio } from "lucide-react";
import AuthenticatedNavigation from "@/components/AuthenticatedNavigation";
import { SermonTranscription } from "@/components/SermonTranscription";
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto p-6 pt-24">
        <div className="flex justify-between items-center mb-8">
          <div>
            <h1 className="text-3xl font-bold text-foreground mb-2">Sermon Management</h1>
            <p className="text-muted-foreground">Manage sermon recordings, notes, and AI transcriptions</p>
          </div>
        </div>
          ...
          <TabsContent value="library" className="space-y-6 mt-6">
            <div className="flex justify-between items-center">
              <div>
                ...
                <p className="text-muted-foreground">Access and manage sermon recordings and notes</p>
              </div>
            ...
            {filteredSermons.length === 0 && (
              <div className="text-center py-12">
                ...
                <h3 className="text-lg font-medium text-muted-foreground mb-2">No sermons found</h3>
                <p className="text-muted-foreground">
                  {searchTerm || filterSeries !== "all" 
                    ? "Try adjusting your search or filter criteria"
                    : "Start by adding your first sermon to the library"
                  }
                </p>
              </div>
            )}
